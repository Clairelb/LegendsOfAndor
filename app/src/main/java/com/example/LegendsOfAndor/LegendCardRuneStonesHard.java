...
public class LegendCardRuneStonesHard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroDieIV = findViewById(R.id.hero_die_rune_stones_hard);
        enemyDieIV = findViewById(R.id.enemy_die_rune_stones_hard);
        rollDice = findViewById(R.id.roll_dice_rune_stones_hard);
        toBoard = findViewById(R.id.to_board_rune_stones_hard);
        runeStonePositionsTV = findViewById(R.id.text_view_rune_stones_hard);
        ...
        rollDice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (runeStonePositions.size() < 5) {
                    ...
                    Toast.makeText(LegendCardRuneStonesHard.this, "You may only roll the die five times.", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View view) {
                if (myPlayer.getPlayer().getUsername().equals(myPlayer.getGame().getPlayers()[0].getUsername())) {
                    if (runeStonePositions.size() == 5) {
                        ...
                        Intent intent = new Intent(LegendCardRuneStonesHard.this, Board.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(LegendCardRuneStonesHard.this, "You must roll the die five times before proceeding to the board.", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Intent intent = new Intent(LegendCardRuneStonesHard.this, Board.class);
                    startActivity(intent);

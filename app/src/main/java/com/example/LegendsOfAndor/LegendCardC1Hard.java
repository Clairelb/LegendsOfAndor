...
public class LegendCardC1Hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legend_card_c1_hard);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        final MyPlayer myPlayer = MyPlayer.getInstance();
        rollDieBTN = findViewById(R.id.roll_die_c1_hard);
        nextLegendCardBTN = findViewById(R.id.next_legend_card_c1_hard);
        heroDieIV = findViewById(R.id.hero_die_c1_hard);
        ...
        rollDieBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (roll == 0) {
                    ...
                    Toast.makeText(LegendCardC1Hard.this, "You may only roll the die once.", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                if(myPlayer.getPlayer().getUsername().equals(myPlayer.getGame().getPlayers()[0].getUsername())) {
                    if (roll != 0) {
                        ...
                        Intent intent = new Intent(LegendCardC1Hard.this, LegendCardC2.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(LegendCardC1Hard.this, "You must roll the die before proceeding to the next legend card.", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Intent intent = new Intent(LegendCardC1Hard.this, LegendCardC2.class);
                    startActivity(intent);
